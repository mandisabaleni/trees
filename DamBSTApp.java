...
/**Creates a Binary Search Tree representation of Dams.
...
public class DamBSTApp{
    ...
    static BinarySearchTree<String> tree = new BinarySearchTree<String>();
    /**Runs main method, puts data of dams into Binary Search Tree.
    ...
    */
    ...
    public static void main (String[] args){
        ...
        try{
            ...
            fw = new PrintWriter(new FileOutputStream("opCountDamBSTApp.txt"));            
            String[] d;
            input.nextLine();
